...
ERROR_MESSAGES = {
    ...
    'data_not_found': gettext_lazy('Faculty member data not found.')
}
...
SUCCESS_MESSAGES = {
    ...
    'data_found': gettext_lazy('Faculty member data found.'),
    'saved_successfully': gettext_lazy('Faculty member data saved successfully.'),
    'updated_successfully':  gettext_lazy('Faculty member data updated successfully.'),
}
