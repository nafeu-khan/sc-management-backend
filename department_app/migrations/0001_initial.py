# Generated by Django 5.0.3 on 2024-07-15 18:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_province', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='state_of_department', to='common.state')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('name', 'campus', 'college'), name='unique_department_details'),
        ),
    ]
